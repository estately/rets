module Rets
  class MeasuringHttpClient
    def initialize(http_client, stats, prefix=nil)
    ...
    def http_get(url, params=nil, extra_headers={})
      @stats.time("rets.measuring_http_client.#{@prefix}http_get") do
        @http_client.http_get(url, params, extra_headers)
      end
    end

    def http_post(url, params, extra_headers = {})
      @stats.time("rets.measuring_http_client.#{@prefix}http_post") do
